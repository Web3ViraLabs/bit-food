window.UILib.renderFooter = window.UILib.renderFooter || function(){
    console.log("renderFooter ");
    if(window.UILib.footerProps.listUnderLogo && window.UILib.footerProps.listUnderLogo[0]){
        document.querySelector("#selected-city").innerText = window.UILib.footerProps.listUnderLogo[0].text;
    }
}
...
$(document).on('click', '#selected-city', function (event) {
